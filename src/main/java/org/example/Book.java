...
public class Book {
    ...
    public Book(String title, String author, BookType type, BookFormat format,
                BookStatus status, String seriesName, double volumeNumber,
                String genre, String themes) {
        this.title = title;
        this.author = author;
        this.type = type;
        this.format = format;
    ...
    public double getVolumeNumber() { return volumeNumber; }
    ...
    public void setVolumeNumber(double volumeNumber) { this.volumeNumber = volumeNumber; }
    ...
    public String getDisplayFormat() {
        ...
        if (format == BookFormat.HARDCOVER) {
            return "Hardcover";
        }
